  ...
  const steps = [
    {
      ...
      title: "Capture",
      description: "Take a clear, well-lit photo of your SET game cards from directly above",
      color: "set-purple",
    ...
    },
    {
      ...
      title: "Analyze",
      description: "Our AI instantly identifies all cards, analyzing shapes, colors, fills, and counts",
      color: "set-green",
    ...
    },
    {
      ...
      title: "Discover",
      description: "See all valid SETs highlighted on your board with visual annotations",
      color: "set-red",
      ...
      <div className="grid grid-cols-3 gap-3 md:gap-4">
        {steps.map((step, index) => (
          ...
          >
            <div 
              className={cn(
                "rounded-xl border border-gray-100/80 shadow-md p-3 md:p-4 h-full",
            ...
            >
              ...
              <div className="flex flex-col gap-2 relative z-10">
                <div 
                  className={`rounded-full p-2.5 md:p-3 mb-1 transition-transform group-hover:scale-110 duration-300 w-fit`}

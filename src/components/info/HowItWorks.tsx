...
const HowItWorks = () => {
  ...
  return (
    <motion.div 
      ...
      initial="hidden" 
      animate="visible" 
      className="w-full max-w-4xl mx-auto px-4 md:px-6 rounded-2xl mt-8 mb-16 relative"
    >
      <motion.div variants={itemVariants} className="text-center mb-8 md:mb-10">
        ...
        <p className="text-gray-500 text-sm md:text-base font-sans max-w-md mx-auto">
          From photo to solution in seconds: A three-step process finds every valid SET combination
        </p>
      </motion.div>
